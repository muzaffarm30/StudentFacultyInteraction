package com.android.studentfaculty.utils;
...
public class SharedPref {
    ...
    static final String shName = "com.android.studentfaculty";
    ...
    public static void init(Context context) {
        if (mSharedPref == null)
            mSharedPref = context.getSharedPreferences("college", Activity.MODE_PRIVATE);
    }
